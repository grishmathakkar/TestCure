...
<ul style="float:right;list-style-type:none;">
  <div class="z"> <li><a class="active"<a href="../soas/testmod2.php" >Account</a></li>
...
<li ><a href="../soas/testmod2.html" >Add Test</a></li>

<li><a href="../soas/testmod7.html" >Delete Test</a></li>

<li><a  <a href="http://localhost/soas/start/soas/testmod3.html" >View Score</a></li>
...
$sql = "SELECT  * FROM `owneracc` where firstname='$sid'";
